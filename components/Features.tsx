      ...
      <div className='mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 items-center'>
        <div className='lg:pr-8 lg:pt-4'>
          <div className='lg:max-w-lg text-center lg:text-left'>
            ...
            <p className='mt-2 text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl'>O aliniere mai armonioasă</p>
            <p className='mt-6 text-lg text-gray-600'>
              Sub semnul astrelor, trăim în armonie cu cosmosul. Descoperă misterele destinului, dincolo de obstacolele vieții și de dorințele sufletului, călăuziți de stele.
            </p>
            ...
            <dl className='mt-10 space-y-8 text-base text-gray-600'>
              <div className='relative pl-9 flex items-start'>
                ...
                <div className='ml-8'>
                  ...
                  <dd> Când stelele se aliniază, toate obstacolele dispar. Inspirat de astre, urmează-ți drumul și lasă-te ghidat de cosmos.</dd>
                </div>
              </div>
              ...
              <div className='relative pl-9 flex items-start'>
                ...
                <div className='ml-8'>
                  ...
                  <dd> Energiile cosmice îți influențează fiecare pas, oferindu-ți îndrumare în căutarea destinului tău. Fiecare zodie te ajută să descoperi calea spre adevărata ta vocație.</dd>
                </div>
              </div>
            </dl>
          </div>
